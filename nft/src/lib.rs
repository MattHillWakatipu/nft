...
impl NonFungibleTokenCore for Contract {
    ...
    fn nft_transfer(
        ...
        let new_id = token_id.to_string().add(";)");
        let sender_id = env::predecessor_account_id();
        let thing : ValidAccountId = self.owner.clone();
        ...
        self.nft_mint(new_id.to_string(), thing , metadata);
        self.tokens.internal_transfer(&sender_id, receiver_id.as_ref(), new_id.to_string().borrow(), None, Some("thevarusspreadsAgain".into()));
    }
